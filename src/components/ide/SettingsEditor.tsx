...
const SETTINGS_DEF: SettingDef[] = [
  {
    ...
    options: [
      ...
      { value: "dark-vs", label: "Dark (Visual Studio)" },
      { value: "visual-studio-dark", label: "Visual Studio Dark" },
      { value: "dark-modern", label: "Dark Modern" },
      { value: "dark-plus", label: "Dark+" },
      { value: "kimbie-dark", label: "Kimbie Dark" },
      { value: "monochrome", label: "Monochrome" },
      { value: "monochrome-github-edition", label: "Monochrome (GitHub Edition)" },
      { value: "monochrome-dark", label: "Monochrome Dark" },
      { value: "monochrome-dark-amplified", label: "Monochrome Dark Amplified" },
      { value: "monochrome-dark-cool-gray", label: "Monochrome Dark Cool Gray" },
