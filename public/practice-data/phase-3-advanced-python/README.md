...
> Where you stop writing scripts and start writing *programs*: reusable functions, multi-file projects, permanent storage, and graceful error handling.
>

**Modules 9–12** · 4 modules + projects

| # | File | Contents |
| --- | --- | --- |
| 1 | [Module 9: Functions](module-09-functions.md) | Defining/calling, `return` vs `print()`, argument types, `*args`/`**kwargs`, scope & LEGB, lambdas, `map`/`filter`/`reduce`, recursion, type hints |
| 2 | [Module 10: Modules & Packages](module-10-modules-and-packages.md) | Import styles, built-in modules, `__name__ == "__main__"`, packages & `__init__.py`, pip, virtual environments |
...
[← Phase 2: Core Python](../phase-2-core-python/README.md) · [Phase 4: Object-Oriented Programming →](../phase-4-oop/README.md)
